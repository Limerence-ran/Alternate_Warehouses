  ...
  <div ref="selectedTableRef">
    ...
    >
      <div class="option">
        ...
        >
          <el-table-column
            v-if="_elProps.tableConfig.multiple"
            fixed
            type="selection"
            reserve-selection
            width="55"
          ...
          <span
            v-for="(item, index) in _elProps.tableConfig.columns"
            :key="index"
          >
            <el-table-column
              :prop="item.prop"
      ...
      >
        <div
          v-if="currentValue"
          class="div-input el-input__inner"
  ...
  methods: {
      ...
      if (
        ...
        request({
          ...
          if (that._elProps.tableConfig.isTree) {
            that.tableData = XEUtils.toArrayTree(data, {
              parentKey: "parent",
              key: "id",
              children: "children",
            });
    ...
    visibleChange() {
      ...
      if (tableConfig.multiple) {
        ...
        that.currentValue
          ? that.currentValue.forEach((item) => {

...
if (oauth2PluginsType) {
  frameOut.push({
    ...
    name: "login",
    component:
      oauth2PluginsType === "local"
        ? _import("plugins/dvadmin-oauth2-web/src/login/index")
        : pluginImport("dvadmin-oauth2-web/src/login/index"),
  });
}
/**
 * 租户申请注册
...
if (tenantsPluginsType) {
  frameOut.push({
    ...
    component:
      tenantsPluginsType === "local"
        ? _import("plugins/dvadmin-tenants-web/src/register/index")
        : pluginImport("dvadmin-tenants-web/src/register/index"),
  });
}
/**
 * 错误页面

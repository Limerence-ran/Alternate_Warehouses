    ...
    return (
        <>
            ...
            <div className='Table' style={{ width: '100%', height: '97%', margin: "2% 0% 2% 0%" }}>
                <Table columns={columns} style={{  }} className='Table' bordered={false} dataSource={data} size="small" rowSelection={null} pagination={{ defaultPageSize: pageSize, onShowSizeChange: handlePaginationChange }} />
            </div>
        </>
    )

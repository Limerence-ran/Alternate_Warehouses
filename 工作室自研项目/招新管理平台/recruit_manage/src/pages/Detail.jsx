                        ...
                        <div id="detail">
                            <div id="basic-wrapper">
                                ...
                                <div className="name">
                                    年龄：
                                    <span className="name-ct">
                                        {studentData?.newerAge}
                                    </span>
                                </div>
                                <div className="name">
                                    C实验成绩：
                                    <span className="name-ct">
                                        {studentData?.newerScoreCe}
                                    </span>
                                </div>
                                <div className="name">
                                    性别：
                                ...
                                <div className="name">
                                    宿舍：
                                    <span className="name-ct">
                                        {studentData?.newerDorm}
                                    </span>
                                </div>
                                <div className="name">
                                    英语(1)成绩：
                                    <span className="name-ct">
                                        {studentData?.newerS_scoreE}
                                    </span>
                                </div>
                                <div className="name">
                                    应征部门：
                                    <span className="name-ct">
                                        {tableData?.newerGroup}
                                    </span>
                                </div>
                                <div className="name">
                                    上学期绩点排名：
                                    <span className="name-ct">
                                        {studentData?.newerRank}
                                    </span>
                                </div>
                                ...
                                <div className="name">
                                    专业班级：
                                    <span className="name-ct">
                                        {tableData?.newerClass}
                                    </span>
                                </div>
                                <div className="name">
                                    是否挂科：
                                    <span className="name-ct">
                                        {studentData?.newerFail}
                                    </span>
                                </div>
                                <div className="name">
                                    手机：
                                    <span className="name-ct">
                                        {tableData?.newerPhone}
                                    </span>
                                </div>
                                <div className="name">
                                    学号：
                                    <span className="name-ct">
                                        {tableData?.newerStudentId}
                                    </span>
                                </div>
                                <div className="name">
                                    C理论成绩：
                                    <span className="name-ct">
                                        {studentData?.newerScoreC}
                                    </span>
                                </div>
                            ...
                            <div id="self-wrapper">
                                <div className="hobby">
                                    <span>爱好：</span>
                                    <div className="name-ct">
                                        {studentData?.newerHobby}
                                    </div>
                                </div>
                                <div className="motto">
                                    <span>座右铭：</span>
                                    <div className="name-ct">
                                        {studentData?.newerMotto}
                                    </div>
                                </div>
                            </div>
                            <div id="bigIntro-wrapper">
                                <div className="experence">
                                    ...
                                    <div className="name-ct">
                                        {studentData?.newerSelf}
                                    </div>
                                </div>
                                <div className="selfCom">
                                    <p>自我评价：</p>
                                    <div className="name-ct">
                                        {studentData?.newerExp}
                                    </div>
                                </div>

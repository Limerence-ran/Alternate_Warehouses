...
import Card01 from "../../charts/card01/main.jsx";
import Card02 from "../../charts/card02/main.jsx";
import Card03 from "../../charts/card03/main.jsx";
        ...
        columns.forEach((column, columnIndex) => {
            ...
            data.forEach((record) => {
                ...
                if (
                    ...
                    isRight = false;
                    // 这里你可以选择抛出异常、记录日志或者其他适当的处理方式
                }
                columnData.push(record[dataIndex]);
            });
            // 将列名作为键，该列下的每行数据作为值
            const obj = {};
            obj[dataIndex] = columnData;
            tableData.push(obj);
        });
        if (!isRight) {
            return message.error("Data cannot be empty.");
        } else {
            // 返回处理后的数据
            return tableData;
        }

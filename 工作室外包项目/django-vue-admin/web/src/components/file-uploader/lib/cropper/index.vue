<template>
  <el-dialog
    class="cropper-uploader quying-dialog"
    :title="title"
  ...
  >
        ...
        <div class="tool-bar">
          <el-button-group>
            <el-button
              ...
              >重新选择</el-button
            >
            <el-button round size="mini" type="" @click="flipX"
              >左右翻转</el-button
            >
            <el-button round size="mini" type="" @click="flipY"
              >上下翻转</el-button
            >
            <el-button
              round
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" size="mini" @click="doCropper()"
        >确 定</el-button
      >
    </div>
  </el-dialog>

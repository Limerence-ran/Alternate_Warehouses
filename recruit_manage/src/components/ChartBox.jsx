    ...
    return (
       <div className={`my-chart ${size}`}>
            <div className='chart-header'>
                <p>{title}</p>
                {
                    isSelect? <MySelect bordered={false} options={Groups} defaultValue="全部"/>:<div className='empty'></div>
                }
            </div>
            <div className='chart-box'>
                <PieChart isSelect={isSelect} data={data} containerName={container} size={size}></PieChart>
            </div>
       </div>
    )
}

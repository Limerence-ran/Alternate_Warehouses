...
function Echart3(){
   ...
   const option = {
       tooltip: {},//tooltip：提示框配置项，用于在鼠标悬停时显示数据信息。
        legend: {
            data: ['bar', 'error']     //图例配置项，用于显示图表中不同系列的标识
        },
       dataZoom: [    //dataZoom：数据区域缩放配置项，可以通过滑动或内部缩放工具来调整图表的显示范围
            {
                type: 'slider'
            },
            {
       ...
       grid: {   //grid：网格配置项，用于设置图表的位置和大小
            bottom: 80 
        },
       xAxis: {},  //定义了X轴的刻度和样式
       yAxis: {}, //定义了Y轴的刻度和样式
       series: [  //系列配置项，用于定义图表中的各个系列（如柱状图、散点图等）
            {
                type: 'scatter',
                name: 'error',
                data: data,

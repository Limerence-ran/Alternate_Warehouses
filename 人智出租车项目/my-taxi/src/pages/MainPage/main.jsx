            ...
            <div className={style.body}>
                <div className={style.header}>
                    <header>
                        ...
                        <div className={style.header_text} > <img src={headerIcon} className={style.header_icon} />
                            <h1>出租车的大数据可视化系统</h1></div>
                        <div className={style.showTime}>{currentTime}</div>
                        <div className={style.navigate_left} >
                            <span className={style.btn_left}>
                                <button><div>区域监控</div></button>
                            </span>
                            <span className={style.btn_left}>
                                <button><div>热点分析</div></button>
                            </span>
                            <span className={style.btn_left}>
                                <button><div>行车轨迹</div></button>
                            </span>
                            <span className={style.btn_left}>
                                <button onClick={()=>setShowDate(!showDate)}><div>预测分析</div></button>
                               
                                {showDate && <div className={style.Timer}>
                                    <span style={{ color: "#a39f9f", fontSize: "12px", fontFamily:"cursive" }}>请选择您要预测的时间</span>
                                    <ul style={{ listStyle: "none", color: "#545050", fontFamily: "cursive" }}>
                                        <li>2017.3.1</li>
                                        <li>2017.3.2</li>
                                        <li>2017.3.3</li>
                                        <li>2017.3.4</li>
                        ...
                        <div className={style.navigate_right} >
                            <span className={style.btn_right}>
                                <button><div>天气主题</div></button>
                            </span>
                            <span className={style.btn_right}>
                                <button><div>登录</div></button>
                            </span>
                        </div>
                    </header>
                </div>
                <div className={style.content_header}>
                    <div className={style.content_header_left}>
                        {!carPath && <LeftOutlined className={style.withdrawnl} onClick={() => setCarPath(!carPath)} />}
                    ...
                    <div className={style.content_header_right}>
                        <span className={style.btn_wrong}>
                            <button onClick={()=>setCarPath(false)}>异常情况</button>
                        </span>
                    </div>
                </div>
